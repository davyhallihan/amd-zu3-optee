...
SRC_URI:append = " file://0001-add-aup-zu3-target.patch file://0002-add-benchmark-pta.patch"

COMPATIBLE_MACHINE:zynqmp = ".*"
OPTEEMACHINE:zynqmp = "zynqmp"
EXTRA_OEMAKE:append:zynqmp = " PLATFORM_FLAVOR=aup_zu3 CFG_TEE_CORE_LOG_LEVEL=4 DEBUG=1 CFG_DDR_SIZE=0x100000000 CFG_TZDRAM_START=0x1E001000 CFG_CORE_TXLAT_TABLES=32 MAX_XLAT_TABLES=32 CFG_CORE_RESERVED_SHM=n CFG_BENCHMARK_PTA=y CFG_SWITCH_BASE=0xA0001000"
